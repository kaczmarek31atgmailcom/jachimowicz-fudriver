...
public class UpdateEmployeeHourlySundayWageCommandHandlerTest {
    @Mock
    ...
    @InjectMocks
    private UpdateEmployeeHourlySundayWageCommandHandler handler;
    ...
    public void shouldUpdateRegularWage(){
        ...
        //Then
        assertEquals(new Long(100),person.getSundayWage());
    }
    ...
    public void shouldCreateValidCommandResult(){
        ...
        assertEquals("SundayWageUpdated",tested.body);
    }

...
public class UpdateEmployeeHourlyBonusWageCommandHandlerTest {
    @Mock
    ...
    @InjectMocks
    private UpdateEmployeeHourlyBonusWageCommandHandler handler;
    ...
    public void shouldUpdateRegularWage(){
        ...
        //Then
        assertEquals(new Long(100),person.getBonusWage());
    }
    ...
    public void shouldCreateValidCommandResult(){
        ...
        assertEquals("BonusWageUpdated",tested.body);
    }
